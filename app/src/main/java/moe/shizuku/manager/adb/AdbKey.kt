...
/**
 * ADB RSA key + TLS material. Adapted from RikkaApps/Shizuku (Apache-2.0).
 */
class AdbKey(private val adbKeyStore: AdbKeyStore, name: String) {
    ...
    companion object {
        ...
        private const val ENCRYPTION_KEY_ALIAS = "_vrcontroler_adbkey_enc_"
    ...
    private fun getOrCreatePrivateKey(): RSAPrivateKey {
        ...
        if (privateKey == null) {
            ...
            privateKey = keyPairGenerator.generateKeyPair().private as RSAPrivateKey
            val enc = encrypt(privateKey.encoded, aad)
    ...
    private val trustManager
        get() = @RequiresApi(Build.VERSION_CODES.R) object : X509ExtendedTrustManager() {
