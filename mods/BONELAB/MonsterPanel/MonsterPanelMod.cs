...
[assembly: MelonInfo(typeof(MonsterPanel.MonsterPanelMod), "MONSTER Panel", "2.30.48", "you")]
    ...
    public class MonsterPanelMod : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            if (_fusionLoaded)
            {
                ...
                FusionPeerMesh.Install(HarmonyInstance); // 0.2.x client AcceptConnection mesh
                TeleportBring.Install(HarmonyInstance); // Bring/Teleport multi-path + retries
        ...
        private static class Teleporter
        {
            ...
            /// Local Fusion teleport + EosDirectSend PlayerRepTeleport to self (EOS hole).
            /// </summary>
            ...
            /// <summary>
            /// Pull player to me. Host: SendPlayerTeleport. Client: EosDirectSend
            /// PlayerRepTeleport to victim PlatformID (EOS — no Teleportation perm; 0.2.0 IsHost bypass).
            /// </summary>
