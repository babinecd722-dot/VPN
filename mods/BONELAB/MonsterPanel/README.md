...
- **Kill Aura** — подстраница-настройки урона по игрокам, **без наведения и крестиков**:
  ...
  - **Lightning FX** — молния бьёт по цели(ям) при убийстве. Оптимизировано: болты из
    фикс-пула (без Instantiate/Destroy в кадре, без GC), удары троттлятся — не лагает даже
    на 8 целях и скорости 60/с. Видно у тебя;
