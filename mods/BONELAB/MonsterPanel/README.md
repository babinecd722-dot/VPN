...
- **Tank Mode** — тебя **нельзя схватить/поднять** (отключаем `AvatarGrip` на своём риге), а ты хватаешь с **мега-силой** (физ-рукам масса ×, жёстко поднимаешь/кидаешь игроков). **Массу тела не трогаем** — ходишь и прыгаешь как обычно, без просадки под весом.
