...
> Наведение (Remote Kill и Disarm) двухступенчатое: сначала **тонкий луч** (точность, схема
> проверена на устройстве), затем **толстая сфера** 0.35 м (прощает промах по движущейся цели).
> Триггеры игнорируются: тела игроков — физические коллайдеры, а режим Collide забивал
> буфер попаданий огромными триггер-зонами уровня, и цель терялась (баг 2.14.0). Буфер 256.
> При неудачном нажатии в лог пишется диагностика `[hits=…, other-rig-hits=…, own-rig-hits=…]`.
