...
{
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern Result EOS_AntiCheatClient_GetModuleBuildId(IntPtr handle, ref GetModuleBuildIdOptionsInternal options, out uint outModuleBuildId);
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern Result EOS_AntiCheatClient_Reserved02(IntPtr handle, ref Reserved02OptionsInternal options);
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern Result EOS_Ecom_CopyLastRedeemEntitlementsResultByIndex(IntPtr handle, ref CopyLastRedeemEntitlementsResultByIndexOptionsInternal options, IntPtr outEntitlementId, ref int inOutEntitlementIdLength);
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern uint EOS_Ecom_GetLastRedeemEntitlementsResultCount(IntPtr handle, ref GetLastRedeemEntitlementsResultCountOptionsInternal options);
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern Result EOS_PresenceModification_SetTemplateData(IntPtr handle, ref PresenceModificationSetTemplateDataOptionsInternal options);

	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern Result EOS_PresenceModification_SetTemplateId(IntPtr handle, ref PresenceModificationSetTemplateIdOptionsInternal options);
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern ulong EOS_RTC_AddNotifyRoomBeforeJoin(IntPtr handle, ref AddNotifyRoomBeforeJoinOptionsInternal options, IntPtr clientData, OnRoomBeforeJoinCallbackInternal completionDelegate);

	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern ulong EOS_RTC_AddNotifyRoomStatisticsUpdated(IntPtr handle, ref AddNotifyRoomStatisticsUpdatedOptionsInternal options, IntPtr clientData, OnRoomStatisticsUpdatedCallbackInternal completionDelegate);
	...
	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern ulong EOS_UI_AddNotifyOnScreenKeyboardRequested(IntPtr handle, ref AddNotifyOnScreenKeyboardRequestedOptionsInternal options, IntPtr clientData, OnScreenKeyboardRequestedCallbackInternal notificationFn);

	[DllImport("EOSSDK-Win64-Shipping.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern Result EOS_UI_ConfigureOnScreenKeyboard(IntPtr handle, ref ConfigureOnScreenKeyboardOptionsInternal options);
